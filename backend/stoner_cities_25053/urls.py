"""stoner_cities_25053 URL Configuration
...
admin.site.site_header = "Stoner Cities"
admin.site.site_title = "Stoner Cities Admin Portal"
admin.site.index_title = "Stoner Cities Admin"

# swagger
api_info = openapi.Info(
    title="Stoner Cities API",
    default_version="v1",
    description="API documentation for Stoner Cities App",
)
